---
title: 'Роль очередей транспорта: Exchange 2013 Help'
TOCTitle: Роль очередей транспорта
ms:assetid: f663005a-4cb0-4c52-9c95-58681fc5eaab
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876955(v=EXCHG.150)
ms:contentKeyID: 50489475
ms.date: 05/22/2018
...
Роль управления `Transport Queues` используется для управления очередями сообщений на отдельном транспортном сервере.
