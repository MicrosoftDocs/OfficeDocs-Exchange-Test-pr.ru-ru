---
title: 'Роль переноса: Exchange 2013 Help'
TOCTitle: Роль переноса
ms:assetid: 8b5a3385-7dc0-4492-9f00-a4616982016b
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876920(v=EXCHG.150)
ms:contentKeyID: 50488593
ms.date: 05/22/2018
...
Роль управления `Migration` позволяет администраторам переносить почтовые ящики и их содержимое как с сервера, так и на сервер.
