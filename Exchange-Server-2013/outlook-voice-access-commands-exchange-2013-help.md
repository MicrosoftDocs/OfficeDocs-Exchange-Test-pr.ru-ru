...
> [!IMPORTANT]  
> Для доступа к сообщению электронной почты, удаленному с помощью голосового доступа к Outlook, можно возвратить удаленное сообщение из папки «Удаленные» в соответствующую папку, используя Outlook Web App или Outlook. С помощью голосового доступа к Outlook нельзя получить доступ к папке «Удаленные».
