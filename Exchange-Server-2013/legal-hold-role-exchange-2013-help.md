---
title: 'Роль хранения для судебного разбирательства: Exchange 2013 Help'
TOCTitle: Роль хранения для судебного разбирательства
ms:assetid: c98ce8ca-3477-479a-ad23-a8e6459bc4d0
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876939(v=EXCHG.150)
ms:contentKeyID: 50489065
ms.date: 04/30/2018
...
Роль управления `Legal Hold` позволяет администраторам указывать, следует ли удерживать данные в определенном почтовом ящике организации в судебных целях.
