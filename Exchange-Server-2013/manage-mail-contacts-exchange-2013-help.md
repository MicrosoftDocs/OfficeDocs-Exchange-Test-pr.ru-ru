...
> [!NOTE]  
> Раздел <strong>Параметры электронной почты</strong> доступен только в Exchange Server 2013. Этот параметр недоступен в Exchange Online.
...
2.  В списке контактов выберите несколько почтовых контактов. Нельзя выполнять массовое редактирование группы из почтовых контактов и почтовых пользователей.
    ...
    > [!TIP]  
    > Можно выделить несколько смежных почтовых контактов. Для этого, удерживая нажатой клавишу SHIFT, щелкните первый почтовый контакт, а затем щелкните последний почтовый контакт, который требуется изменить. Можно выбрать несколько почтовых контактов. Для этого, удерживая клавишу CTRL, щелкните каждый почтовый контакт, который требуется изменить.
