---
title: 'Роль пограничных подписок: Exchange 2013 Help'
TOCTitle: Роль пограничных подписок
ms:assetid: 7de1a663-96fb-4fb5-898a-effa82653597
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876912(v=EXCHG.150)
ms:contentKeyID: 50488504
ms.date: 05/22/2018
...
Роль управления `Edge Subscriptions` позволяет администраторам управлять пограничной синхронизацией и конфигурацией подписки между пограничными транспортными серверами Microsoft Exchange Server 2010 и серверами почтовых ящиков Microsoft Exchange Server 2013 в организации.
