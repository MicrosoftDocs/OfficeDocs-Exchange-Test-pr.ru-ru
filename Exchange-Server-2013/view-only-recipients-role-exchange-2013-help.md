---
title: 'Роль получателей с правами только на просмотр: Exchange 2013 Help'
TOCTitle: Роль получателей с правами только на просмотр
ms:assetid: 37e66b92-81d3-412f-b7a9-e1bb8cbeb468
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876872(v=EXCHG.150)
ms:contentKeyID: 50487828
ms.date: 05/22/2018
...
Роль управления `View-Only Recipients` позволяет администраторам просматривать настройки получателей, таких как почтовые ящики, почтовые пользователи, почтовые контакты, группы рассылки и динамические группы рассылки.

Данная роль может сочетаться с ролями, связанными с ролью `View-Only Configuration`, для создания группы ролей с целью просмотра каждого объекта в организации. Дополнительные сведения см. в разделе [Роль конфигурации с правами только на просмотр](view-only-configuration-role-exchange-2013-help.md).
