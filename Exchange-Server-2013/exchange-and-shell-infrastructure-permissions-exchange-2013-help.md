...
<tbody>
<tr class="odd">
<td>Группе ролей управления также можно вручную назначить роль управления &quot;Журналы аудита с правом только на просмотр&quot;. Дополнительные сведения см. в разделе <a href="view-only-audit-logs-role-exchange-2013-help.md">Роль только для просмотра журналов аудита</a>.</td>
</tr>
</tbody>
</table>
