---
title: 'Роль управления правами на доступ к данным: Exchange 2013 Help'
TOCTitle: Роль управления правами на доступ к данным
ms:assetid: bb40c2ec-1eb8-43d4-af7c-4fa74c7c3ce2
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876934(v=EXCHG.150)
ms:contentKeyID: 50489004
ms.date: 05/22/2018
...
Роль управления `Information Rights Management` позволяет администратору управлять возможностями Exchange в части управления правами на доступ к данным в организации.
