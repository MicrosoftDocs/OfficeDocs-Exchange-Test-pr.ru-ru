---
title: 'Роль конфигурации организации: Exchange 2013 Help'
TOCTitle: Роль конфигурации организации
ms:assetid: db952cc5-ef70-4366-acbb-0e292d4cbdd0
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876946(v=EXCHG.150)
ms:contentKeyID: 50489337
ms.date: 05/22/2018
...
Роль управления `Organization Configuration` позволяет администраторам управлять параметрами всей организации. С помощью этой роли можно управлять следующими настройками организации:

  - включение и отключение подсказок в организации;

  - URL-адрес начальной страницы управляемой папки;

  - SMTP-адреса получателей Microsoft Exchange и альтернативные адреса электронной почты;

  - конфигурация схемы свойств почтового ящика ресурса;

  - URL-адреса справки Центра администрирования Exchange и Microsoft Office Outlook Web App;

Этот тип роли не содержит разрешения, имеющиеся в ролях `Organization Client Access` и `Organization Transport Settings`.
