---
title: 'Роль агентов транспорта: Exchange 2013 Help'
TOCTitle: Роль агентов транспорта
ms:assetid: 1679402e-158f-4630-8ef1-01ab5c7ce811
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876853(v=EXCHG.150)
ms:contentKeyID: 50487516
ms.date: 05/22/2018
...
Роль управления `Transport Agents` позволяет администраторам управлять агентами транспорта в организации.
