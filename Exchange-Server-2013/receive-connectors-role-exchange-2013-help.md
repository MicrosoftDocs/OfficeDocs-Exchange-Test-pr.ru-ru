---
title: 'Роль соединителей получения: Exchange 2013 Help'
TOCTitle: Роль соединителей получения
ms:assetid: a7c5a086-5066-4ece-9b22-cc1048d2f2bc
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876927(v=EXCHG.150)
ms:contentKeyID: 50488823
ms.date: 05/22/2018
...
Для управления конфигурацией транспортных соединителей приема используется роль управления `Receive Connectors`. Например, с помощью этой роли можно задавать ограничения на размер сообщения на отдельном сервере.
