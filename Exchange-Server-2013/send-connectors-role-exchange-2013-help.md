---
title: 'Роль соединителей отправки: Exchange 2013 Help'
TOCTitle: Роль соединителей отправки
ms:assetid: 8021e279-2b74-469e-aa6d-d0197f34ba6c
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876913(v=EXCHG.150)
ms:contentKeyID: 50488467
ms.date: 05/22/2018
...
Роль управления `Send Connectors` позволяет администраторам управлять соединителями отправки транспорта в организации.
