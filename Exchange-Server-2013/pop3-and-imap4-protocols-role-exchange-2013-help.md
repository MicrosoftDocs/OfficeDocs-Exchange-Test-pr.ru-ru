---
title: 'Роль протоколов POP3 и IMAP4: Exchange 2013 Help'
TOCTitle: Роль протоколов POP3 и IMAP4
ms:assetid: 67dd66e0-3cca-4f87-8165-4918519b39b6
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876898(v=EXCHG.150)
ms:contentKeyID: 50488345
ms.date: 05/22/2018
...
Роль управления `POP3 and IMAP4 Protocols` позволяет администраторам на отдельных серверах управлять конфигурацией служб POP3 и IMAP4, например параметрами проверки подлинности и подключения.
