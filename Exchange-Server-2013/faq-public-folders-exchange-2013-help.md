...
<tbody>
<tr class="odd">
<td>Правила общих папок, которые содержат элемент <strong>ответить, используя указанный шаблон</strong>, можно создать только в общих папках с включенной поддержкой почты. Возможно, что существующие правила, содержащие элемент <strong>ответить, используя указанный шаблон</strong>, продолжат работать с общими папками с отключенной поддержкой почты, но для таких папок невозможно создать новые правила с этим элементом шаблона или изменить существующие правила с этим элементом.</td>
</tr>
</tbody>
</table>
