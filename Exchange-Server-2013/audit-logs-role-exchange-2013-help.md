---
title: 'Роль журналов аудита: Exchange 2013 Help'
TOCTitle: Роль журналов аудита
ms:assetid: 36a7d375-76f8-441c-9da1-8a50dbd062f1
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876870(v=EXCHG.150)
ms:contentKeyID: 50487816
ms.date: 05/22/2018
...
Роль управления `Audit Logs` позволяет администраторам настроить журнал аудита администратора в организации.
