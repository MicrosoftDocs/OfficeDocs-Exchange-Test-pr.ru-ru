---
title: 'Роль импорта и экспорта почтового ящика: Exchange 2013 Help'
TOCTitle: Роль импорта и экспорта почтового ящика
ms:assetid: d7cdce7a-6c46-4750-b237-d1c1773e8d28
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Ee633482(v=EXCHG.150)
ms:contentKeyID: 50489311
ms.date: 04/30/2018
...
Роль `Mailbox Import Export` позволяет администраторам импортировать и экспортировать содержимое почтовых ящиков, а также удалять нежелательное содержимое из почтовых ящиков.
