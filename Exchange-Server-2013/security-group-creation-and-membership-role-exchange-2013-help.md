---
title: 'Роль создания и членства в группе безопасности: Exchange 2013 Help'
TOCTitle: Роль создания и членства в группе безопасности
ms:assetid: 257eb517-339f-4895-9e08-f772408a41cf
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876860(v=EXCHG.150)
ms:contentKeyID: 50487683
ms.date: 04/30/2018
...
Роль управления `Security Group Creation and Membership` позволяет администраторам создавать универсальные группы безопасности, а также управлять ими и их членством в организации.
...
При включении в организации разделенных разрешений Active Directory все назначения неделегируемых ролей управления для этой роли управления были удалены. При включении разделения решений Active Directory только администраторы Active Directory могут создавать участников безопасности, например пользователей и группы безопасности, при помощи средств управления Active Directory.

Дополнительные сведения см. в разделе [Общие сведения о разделенных разрешениях](understanding-split-permissions-exchange-2013-help.md).
