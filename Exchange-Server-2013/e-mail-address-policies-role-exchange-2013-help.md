---
title: 'Роль политик адресов электронной почты: Exchange 2013 Help'
TOCTitle: Роль политик адресов электронной почты
ms:assetid: d272e672-81ea-417c-b5d6-76a5efd5c036
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876944(v=EXCHG.150)
ms:contentKeyID: 50489284
ms.date: 05/22/2018
...
Роль управления `E-Mail Address Policies` позволяет администраторам управлять политиками адресов электронной почты в организации.
