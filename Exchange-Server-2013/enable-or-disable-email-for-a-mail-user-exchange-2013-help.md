---
title: 'Exchange 2013: включение и отключение почты для почтового пользователя'
...
Дополнительные сведения о задачах управления, связанных с почтовыми пользователями, см. в разделе [Управление пользователями почты](https://docs.microsoft.com/ru-ru/exchange/recipients-in-exchange-online/manage-mail-users).
