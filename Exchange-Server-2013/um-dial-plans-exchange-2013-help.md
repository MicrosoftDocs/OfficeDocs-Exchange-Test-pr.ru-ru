...
> [!IMPORTANT]  
> При создании абонентской группы единой системы обмена сообщениями всегда создается политика почтовых ящиков единой системы обмена сообщениями по умолчанию. Политика почтовых ящиков единой системы обмена сообщениями называется политикой &lt;<strong>&gt; по умолчанию. Эту политику почтовых ящиков можно удалить или настроить в соответствии с потребностями.</strong>
