---
title: 'Роль общедоступных папок с включенной поддержкой почты: Exchange 2013 Help'
TOCTitle: Роль общедоступных папок с включенной поддержкой почты
ms:assetid: 22289ae1-f9e8-4c98-aaad-ee623e05eadd
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876859(v=EXCHG.150)
ms:contentKeyID: 50487666
ms.date: 05/22/2018
...
Роль управления `Mail Enabled Public Folders` позволяет администраторам включать или отключать поддержку почты для отдельных общих папок в организации.

Эта роль позволяет управлять только свойствами электронной почты общих папок. Она не позволяет управлять свойствами общих папок, не связанных с электронной почтой. Для управления свойствами общих папок, не связанных с электронной почтой, необходимо использовать роль `Public Folders`. Дополнительные сведения см. в разделе [Роль общедоступных папок](public-folders-role-exchange-2013-help.md).
