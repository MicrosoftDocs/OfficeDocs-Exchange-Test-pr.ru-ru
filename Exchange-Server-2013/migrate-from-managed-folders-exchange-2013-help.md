...
> [!NOTE]  
> Вы также можете использовать консоль управления Exchange для создания тегов хранения вручную (не на основе параметров в управляемых папках). Дополнительные сведения см. в разделе <a href="https://docs.microsoft.com/ru-ru/exchange/security-and-compliance/messaging-records-management/create-a-retention-policy">Создание политики хранения</a>.
...
> [!NOTE]  
> Вы также можете использовать консоль управления Exchange для создания политики хранения и добавления в нее тегов хранения. Дополнительные сведения см. в разделе <a href="https://docs.microsoft.com/ru-ru/exchange/security-and-compliance/messaging-records-management/create-a-retention-policy">Создание политики хранения</a>.
...
> [!NOTE]  
> Вы также можете использовать консоль управления Exchange, чтобы применить политику хранения к пользователям. Дополнительные сведения см. в разделе <a href="https://docs.microsoft.com/ru-ru/exchange/security-and-compliance/messaging-records-management/apply-retention-policy">Применение политики хранения к почтовым ящикам</a>.
