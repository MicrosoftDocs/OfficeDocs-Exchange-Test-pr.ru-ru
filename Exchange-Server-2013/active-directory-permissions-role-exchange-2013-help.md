---
title: 'Роль разрешений Active Directory: Exchange 2013 Help'
TOCTitle: Роль разрешений Active Directory
ms:assetid: 0908b4cb-08fd-44f6-bab6-c66af64b2d1a
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876845(v=EXCHG.150)
ms:contentKeyID: 50487391
ms.date: 04/30/2018
...
Роль управления `Active Directory Permissions` позволяет администраторам настраивать разрешения Active Directory в организации. Некоторые функции, использующие разрешения Active Directory или список управления доступом, включают в себя транспортные соединители получения и отправки, и разрешения "Отправить как" и "Отправить от имени" для почтовых ящиков.
...
<tbody>
<tr class="odd">
<td>Разрешения, установленные напрямую для объектов Active Directory, могут не применяться в управлении доступом на основе ролей.</td>
</tr>
</tbody>
</table>
