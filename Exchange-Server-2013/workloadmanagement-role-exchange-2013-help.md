---
title: 'Роль WorkloadManagement: Exchange 2013 Help'
TOCTitle: Роль WorkloadManagement
ms:assetid: d5c90eae-95c3-44b0-add5-a97337d17743
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ657498(v=EXCHG.150)
ms:contentKeyID: 50489152
ms.date: 05/22/2018
...
Роль управления `WorkloadManagement` позволяет администраторам управлять политиками рабочих нагрузок. Администраторы могут настраивать определения работоспособности ресурсов, классификации рабочих нагрузок, а также включать и выключать управление рабочими нагрузками. Вносить изменения можно только под руководством службы поддержки пользователей Майкрософт.
