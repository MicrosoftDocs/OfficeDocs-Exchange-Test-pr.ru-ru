---
title: 'Роль конфигурации с правами только на просмотр: Exchange 2013 Help'
TOCTitle: Роль конфигурации с правами только на просмотр
ms:assetid: 72607063-7f2d-4b3e-a2a9-27eb88e1e16a
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876907(v=EXCHG.150)
ms:contentKeyID: 50488221
ms.date: 05/22/2018
...
Для просмотра всех параметров конфигурации Exchange в организации, не относящихся к получателям, используется роль управления `View-Only Configuration`. Примерами конфигураций, доступных для просмотра, являются конфигурации сервера, транспорта, базы данных и всей организации.

Эту роль можно объединять с ролями, которые относятся к типу ролей `View-Only Recipients`, для создания группы ролей, позволяющих просмотреть любой объект в организации. Дополнительные сведения см. в разделе [Роль получателей с правами только на просмотр](view-only-recipients-role-exchange-2013-help.md).
