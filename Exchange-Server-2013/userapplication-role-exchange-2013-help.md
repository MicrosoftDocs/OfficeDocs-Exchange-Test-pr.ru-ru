---
title: 'Роль UserApplication: Exchange 2013 Help'
TOCTitle: Роль UserApplication
ms:assetid: a4621e45-53db-42f7-a5d7-c1900a154b4e
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ657476(v=EXCHG.150)
ms:contentKeyID: 50488778
ms.date: 05/22/2018
...
Роль управления `UserApplication` позволяет партнерским приложениям действовать от имени конечных пользователей.
