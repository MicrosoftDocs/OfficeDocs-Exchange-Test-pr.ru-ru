---
title: 'Роль "Мои настраиваемые приложения": Exchange 2013 Help'
TOCTitle: Роль "Мои настраиваемые приложения"
ms:assetid: aa0321b3-2ec0-4694-875b-7a93d3d99089
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ657478(v=EXCHG.150)
ms:contentKeyID: 50488816
ms.date: 05/22/2018
...
Роль "Мои настраиваемые приложения" позволяет пользователям добавлять приложения из файла или URL-адреса.
