---
title: 'Роль советов по использованию электронной почты: Exchange 2013 Help'
TOCTitle: Роль советов по использованию электронной почты
ms:assetid: 74495ded-6097-4f10-a829-c8ed81f5ba3e
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876909(v=EXCHG.150)
ms:contentKeyID: 50488233
ms.date: 05/22/2018
...
Роль управления Mail Tips позволяет администраторам управлять подсказками почты в организации.
