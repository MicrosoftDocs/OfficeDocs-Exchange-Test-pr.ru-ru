---
title: 'Роль запросов единой системы обмена сообщениями: Exchange 2013 Help'
TOCTitle: Роль запросов единой системы обмена сообщениями
ms:assetid: 262928e8-b938-404f-b941-a636f4d18169
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876861(v=EXCHG.150)
ms:contentKeyID: 50487638
ms.date: 05/22/2018
...
Роль управления `UM Prompts` позволяет администраторам создавать и управлять пользовательскими голосовыми приглашениями единой системы управления сообщениями в организации.
