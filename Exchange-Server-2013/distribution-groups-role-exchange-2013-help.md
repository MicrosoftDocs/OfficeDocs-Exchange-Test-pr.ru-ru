---
title: 'Роль групп рассылки: Exchange 2013 Help'
TOCTitle: Роль групп рассылки
ms:assetid: 0c3667b6-529b-4bb2-85bf-e24fae82d082
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876848(v=EXCHG.150)
ms:contentKeyID: 50487406
ms.date: 04/30/2018
...
Роль управления `Distribution Groups` позволяет администраторам создавать, изменять, просматривать и удалять группы рассылки, а также добавлять и удалять участников группы рассылки в организации.
