...
<p>По умолчанию эта подсказка отключена. Ее можно включить с помощью командлета <strong>Set-OrganizationConfig</strong>. Дополнительные сведения см. в разделе <a href="https://docs.microsoft.com/ru-ru/exchange/clients-and-mobile-in-exchange-online/mailtips/mailtips-over-organization-relationships">Подсказки в рамках связей организации</a>.</p>
<p>Если некоторые почтовые ящики размещаются в Exchange Online и вы находитесь в режиме сосуществования с Exchange Online, параметр в объекте удаленного домена, который представляет удаленную часть организации, оказывает прямое влияние на способ обработки этой подсказки.</p>
...
<p>Инструкции по настройке управляемых получателей в Exchange 2013 см. в разделе <a href="https://docs.microsoft.com/ru-ru/exchange/security-and-compliance/mail-flow-rules/common-message-approval-scenarios">Распространенные сценарии утверждения сообщений</a>.</p>
...
> [!NOTE]  
> В связи со сложностями в реализации ограничения на размер сообщения на соединителях в организации не учитываются.
