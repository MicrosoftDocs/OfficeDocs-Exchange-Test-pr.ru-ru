---
title: 'Роль параметров пользователя: Exchange 2013 Help'
TOCTitle: Роль параметров пользователя
ms:assetid: fb4d58f5-cc62-4ce8-b2e4-c3cc91795a12
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876960(v=EXCHG.150)
ms:contentKeyID: 50489506
ms.date: 05/22/2018
...
Роль управления `User Options` позволяет администраторам просматривать параметры Outlook Web App для пользователя в организации. Эта роль может использоваться для диагностики проблем конфигурации.
