---
title: 'Роль MyName: Exchange 2013 Help'
TOCTitle: Роль MyName
ms:assetid: 6c8320d3-7a71-4975-b8b3-c1b1b52dd7df
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Ff461931(v=EXCHG.150)
ms:contentKeyID: 50488368
ms.date: 05/22/2018
...
Роль управления `MyName` позволяет определенным пользователям просматривать и изменять свое полное имя и сведения в поле заметок. Это пользовательская роль, созданная из родительской роли [Роль MyProfileInformation](myprofileinformation-role-exchange-2013-help.md).
