---
title: 'Роль поддержки диагностики: Exchange 2013 Help'
TOCTitle: Роль поддержки диагностики
ms:assetid: 3ad2c628-019e-4eb7-af43-64ab2a3a2fbf
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876875(v=EXCHG.150)
ms:contentKeyID: 50487854
ms.date: 05/22/2018
...
Роль управления `Support Diagnostics` позволяет администраторам проводить расширенную диагностику под руководством службы технической поддержки Microsoft в организации.
...
<tbody>
<tr class="odd">
<td>С помощью этой роли выдаются разрешения для командлетов и сценариев, которые должны использоваться только под руководством службы технической поддержки.</td>
</tr>
</tbody>
</table>
