...
> [!CAUTION]  
> С помощью этой роли выдаются разрешения для командлетов и сценариев, которые должны использоваться только под руководством службы технической поддержки.
