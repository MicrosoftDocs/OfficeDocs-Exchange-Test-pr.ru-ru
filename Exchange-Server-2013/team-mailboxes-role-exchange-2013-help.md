---
title: 'Роль почтовых ящиков рабочей группы: Exchange 2013 Help'
TOCTitle: Роль почтовых ящиков рабочей группы
ms:assetid: b4591082-c4af-41bf-bbb1-ed2b931e62fb
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ657485(v=EXCHG.150)
ms:contentKeyID: 50488925
ms.date: 05/22/2018
...
Роль управления `Team Mailboxes` позволяет администраторам определять одну или несколько политик для подготовки почтовых ящиков сайта и управлять почтовыми ящиками сайта в организации. Администраторы, которым назначена эта роль, могу управлять почтовыми ящиками сайта, которыми они не владеют.
