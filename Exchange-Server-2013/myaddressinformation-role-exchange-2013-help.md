---
title: 'Роль MyAddressInformation: Exchange 2013 Help'
TOCTitle: Роль MyAddressInformation
ms:assetid: b1be0e3d-53b9-4810-a225-3d0b203d90d4
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Ff461936(v=EXCHG.150)
ms:contentKeyID: 50488913
ms.date: 05/22/2018
...
Пользователи могут использовать роль управления `MyAddressInformation` для просмотра и изменения адреса, номера рабочего телефона и факса. Это пользовательская роль, созданная из родительской роли [Роль MyContactInformation](mycontactinformation-role-exchange-2013-help.md).
