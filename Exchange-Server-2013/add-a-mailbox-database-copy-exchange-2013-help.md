...
3.  На странице **Добавление копии базы данных почтовых ящиков** щелкните **Обзор**, выберите сервер почтовых ящиков, на котором будет размещена копия базы данных, а затем щелкните **ОК**.
