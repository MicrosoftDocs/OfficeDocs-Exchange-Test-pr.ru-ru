---
title: 'Роль аварийного восстановления: Exchange 2013 Help'
TOCTitle: Роль аварийного восстановления
ms:assetid: 6dd321a8-7621-44be-b3c5-76535e006653
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876902(v=EXCHG.150)
ms:contentKeyID: 50488199
ms.date: 05/22/2018
...
Роль управления `Disaster Recovery` позволяет администраторам восстанавливать почтовые ящики и базы данных почтовых ящиков, создавать базы данных почтовых ящиков, а также выполнять переключение центра обработки данных для групп обеспечения доступности баз данных в организации.
