...
> [!NOTE]  
> Почтовый ящик, в который импортируются данные, должен существовать. Нельзя импортировать данные в учетную запись пользователя, у которой отсутствует почтовый ящик.
