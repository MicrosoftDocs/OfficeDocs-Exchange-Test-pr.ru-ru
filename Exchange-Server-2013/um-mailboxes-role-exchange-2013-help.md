---
title: 'Роль почтовых ящиков единой системы обмена сообщениями: Exchange 2013 Help'
TOCTitle: Роль почтовых ящиков единой системы обмена сообщениями
ms:assetid: 6c9442dc-e674-4474-888e-e2f391a8eb57
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876901(v=EXCHG.150)
ms:contentKeyID: 50488193
ms.date: 05/22/2018
...
Роль управления `UM Mailboxes` позволяет администраторам управлять настройкой единой системы обмена сообщениями для почтовых ящиков и других получателей в организации.
