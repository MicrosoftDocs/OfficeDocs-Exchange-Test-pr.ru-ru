---
title: 'Роль OfficeExtensionApplication: Exchange 2013 Help'
TOCTitle: Роль OfficeExtensionApplication
ms:assetid: a78f69b8-2403-40a0-8c86-7e0fb7b10d29
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ657479(v=EXCHG.150)
ms:contentKeyID: 50488787
ms.date: 05/22/2018
...
Роль управления `OfficeExtensionApplication` позволяет приложениям расширения Microsoft Office обращаться к почтовым ящикам пользователей.
