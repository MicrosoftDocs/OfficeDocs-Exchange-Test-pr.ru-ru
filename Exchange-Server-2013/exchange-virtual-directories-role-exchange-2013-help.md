---
title: 'Роль виртуальных каталогов Exchange: Exchange 2013 Help'
TOCTitle: Роль виртуальных каталогов Exchange
ms:assetid: d10896e9-3574-42bb-9090-61f3abc33005
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876942(v=EXCHG.150)
ms:contentKeyID: 50489126
ms.date: 05/22/2018
...
Роль управления `Exchange Virtual Directories` позволяет администраторам управлять виртуальными каталогами Microsoft Office Outlook Web App, Microsoft ActiveSync, автономных адресных книг, функции автообнаружения, среды Windows PowerShell и веб-интерфейса администрирования на отдельных серверах.
