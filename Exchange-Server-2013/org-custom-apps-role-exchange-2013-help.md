---
title: 'Роль "Настраиваемые приложения Org": Exchange 2013 Help'
TOCTitle: Роль "Настраиваемые приложения Org"
ms:assetid: ab2aac13-f783-43e6-a369-75cce1d4943f
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ657482(v=EXCHG.150)
ms:contentKeyID: 50488830
ms.date: 05/22/2018
...
Роль управления "Настраиваемые приложения Org" позволяет администраторам просматривать и изменять приложения в организации и добавлять пользовательские приложения из файла или URL-адреса.
