...
> [!TIP]  
> Если в вашей организации нет отдельной группы, управляющей схемой Active Directory, вы можете пропустить этот шаг и сразу перейти к разделу Подготовка Active Directory. Если схема на шаге 1 не будет расширена, команды шага 2 расширят схему для вас. Даже если вы решили пропустить шаг 1, следует помнить о приведенных выше рекомендациях.
