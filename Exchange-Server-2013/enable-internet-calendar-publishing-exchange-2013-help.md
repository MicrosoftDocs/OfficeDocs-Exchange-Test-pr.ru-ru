...
> [!NOTE]  
> Это действие необходимо, только если в вашей организации уже есть URL-адрес веб-прокси. В противном случае перейдите к действию 2.<br />
Для настройки URL-адреса веб-прокси нельзя использовать центр администрирования Exchange (EAC).
...
> [!NOTE]  
> Центр администрирования Exchange нельзя использовать для включения публикации виртуального каталога.
...
> [!NOTE]  
> Приведенные ниже варианты относятся только к средам Exchange Online.
