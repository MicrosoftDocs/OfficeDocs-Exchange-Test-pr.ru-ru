---
title: 'Роль общедоступных папок: Exchange 2013 Help'
TOCTitle: Роль общедоступных папок
ms:assetid: b858f04c-ac0b-495f-9193-8b9645781f73
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876930(v=EXCHG.150)
ms:contentKeyID: 50488990
ms.date: 05/22/2018
...
Роль управления `Public Folders ` позволяет администраторам управлять общими папками в организации.

Эта роль не позволяет управлять поддержкой почты для общедоступных папок. Для включения и отключения поддержки почты для общей папки необходимо быть участником роли, связанной с ролью `Mail Enabled Public Folders `. Дополнительные сведения см. в разделе [Роль общедоступных папок с включенной поддержкой почты](mail-enabled-public-folders-role-exchange-2013-help.md).
