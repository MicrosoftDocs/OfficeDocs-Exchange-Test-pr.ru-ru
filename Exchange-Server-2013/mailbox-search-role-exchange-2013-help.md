---
title: 'Роль поиска в почтовом ящике: Exchange 2013 Help'
TOCTitle: Роль поиска в почтовом ящике
ms:assetid: f86b63ba-0c67-4748-8965-0c08a6a8aec1
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876958(v=EXCHG.150)
ms:contentKeyID: 50489483
ms.date: 04/30/2018
...
Роль управления `Mailbox Search` предназначена для поиска по содержимому одного или более почтовых ящиков в организации.
