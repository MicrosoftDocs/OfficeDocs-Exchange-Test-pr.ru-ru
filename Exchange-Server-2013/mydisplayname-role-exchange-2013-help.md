---
title: 'Роль MyDisplayName: Exchange 2013 Help'
TOCTitle: Роль MyDisplayName
ms:assetid: d78d0032-29af-476b-82e3-69364ca7f12f
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Ff461938(v=EXCHG.150)
ms:contentKeyID: 50489164
ms.date: 05/22/2018
...
Роль управления `MyDisplayName` позволяет отдельным пользователям просматривать и изменять свои отображаемые имена. Это пользовательская роль, созданная из родительской роли [Роль MyProfileInformation](myprofileinformation-role-exchange-2013-help.md).
