...
<li><p>Срок хранения неповторяющейся задачи, для которой не заданы параметры <code>message-received date</code> и <code>message-creation date</code>, не ограничен.</p></li>
</ol></li>
