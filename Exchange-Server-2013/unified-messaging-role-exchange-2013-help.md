---
title: 'Роль единой системы обмена сообщениями: Exchange 2013 Help'
TOCTitle: Роль единой системы обмена сообщениями
ms:assetid: bf24aa04-5843-4cf3-83e7-3a5fa7bd3522
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876935(v=EXCHG.150)
ms:contentKeyID: 50489022
ms.date: 05/22/2018
...
Роль `Unified Messaging` позволяет администраторам управлять службами единой системы обмена сообщениями в организации.

Эта роль не позволяет управлять конфигурацией почтового ящика единой системы обмена сообщениями или запросами этой системы. Для управления параметрами почтового ящика единой системы обмена сообщениями используйте роли, связанные с ролью `UM Mailboxes `. Для управления приглашениями единой системы обмена сообщениями используйте роли, связанные с ролью `UM Prompts`. Дополнительные сведения см. в следующих разделах:
