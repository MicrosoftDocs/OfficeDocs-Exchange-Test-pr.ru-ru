---
title: 'Роль TeamMailboxLifecycleApplication: Exchange 2013 Help'
TOCTitle: Роль TeamMailboxLifecycleApplication
ms:assetid: 3cd2cd6f-65e1-4e66-a017-054060c46fe1
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ673057(v=EXCHG.150)
ms:contentKeyID: 50487919
ms.date: 05/22/2018
...
Роль управления `TeamMailboxLifecycleApplication` позволяет партнерским приложениям обновлять состояние жизненного цикла почтового ящика сайта.
