---
title: 'Роль удаленных и обслуживаемых доменов: Exchange 2013 Help'
TOCTitle: Роль удаленных и обслуживаемых доменов
ms:assetid: 340c7546-5236-4743-a2b3-3c2363f3da1d
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876869(v=EXCHG.150)
ms:contentKeyID: 50487788
ms.date: 05/22/2018
...
Роль управления `Remote and Accepted Domains` позволяет администраторам управлять удаленными и обслуживаемыми доменами в организации.
