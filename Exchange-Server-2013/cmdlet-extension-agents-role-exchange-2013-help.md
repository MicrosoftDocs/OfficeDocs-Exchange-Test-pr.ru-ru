---
title: 'Роль агентов расширения командлетов: Exchange 2013 Help'
TOCTitle: Роль агентов расширения командлетов
ms:assetid: 20f9f7c2-a8e5-468e-b1a8-c87c562a2be7
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876857(v=EXCHG.150)
ms:contentKeyID: 50487601
ms.date: 05/22/2018
...
Роль управления `Cmdlet Extension Agents` позволяет администраторам включать, отключать и устанавливать приоритет агентов расширения командлета в организации.
