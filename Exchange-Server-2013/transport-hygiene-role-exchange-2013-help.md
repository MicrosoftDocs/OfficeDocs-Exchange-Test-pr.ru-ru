---
title: 'Роль санации транспорта: Exchange 2013 Help'
TOCTitle: Роль санации транспорта
ms:assetid: 629792e4-7a8f-4447-b031-1c7d7c994b8a
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876893(v=EXCHG.150)
ms:contentKeyID: 50488146
ms.date: 05/22/2018
...
Роль управления `Transport Hygiene` позволяет администраторам управлять средствами защиты от нежелательной почты и вредоносных программ в организации.
