---
title: 'Роль "Приложения Org Marketplace": Exchange 2013 Help'
TOCTitle: Роль "Приложения Org Marketplace"
ms:assetid: 137ee328-0bad-4911-a7bf-82da7678f246
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ673043(v=EXCHG.150)
ms:contentKeyID: 50487524
ms.date: 05/22/2018
...
Роль управления "Приложения Org Marketplace" позволяет администраторам просматривать и изменять приложения в пределах своих организаций, а также добавлять их из Магазина Office.
