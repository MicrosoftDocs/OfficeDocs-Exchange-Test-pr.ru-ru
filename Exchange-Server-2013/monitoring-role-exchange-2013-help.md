---
title: 'Роль мониторинга: Exchange 2013 Help'
TOCTitle: Роль мониторинга
ms:assetid: ba4cb787-8e17-4565-bccd-74e846c06a4f
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876933(v=EXCHG.150)
ms:contentKeyID: 50488948
ms.date: 05/22/2018
...
Роль управления «Мониторинг» позволяет администраторам отслеживать доступность служб и компонентов Exchange в организации. Эта роль также может использоваться с учетными записями служб, используемыми наблюдаемыми приложениями для сбора сведений о состоянии серверов, на которых выполняется Exchange.
