---
title: 'Роль клиентского доступа организации: Exchange 2013 Help'
TOCTitle: Роль клиентского доступа организации
ms:assetid: ff84799a-b79c-498d-b797-7675a4afb1eb
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876962(v=EXCHG.150)
ms:contentKeyID: 50489539
ms.date: 04/30/2018
...
Роль управления `Organization Client Access` используется для управления параметрами сервера клиентского доступа в организации.
