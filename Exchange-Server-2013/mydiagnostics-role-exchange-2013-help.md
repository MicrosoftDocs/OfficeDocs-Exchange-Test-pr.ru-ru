---
title: 'Роль MyDiagnostics: Exchange 2013 Help'
TOCTitle: Роль MyDiagnostics
ms:assetid: 62ba4bdd-6301-4daf-9368-3b393213ec1d
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd979793(v=EXCHG.150)
ms:contentKeyID: 50488148
ms.date: 05/22/2018
...
Роль управления `MyDiagnostics` позволяет отдельным пользователям выполнять основную диагностику почтовых ящиков, например получение сведений о диагностике календаря.
