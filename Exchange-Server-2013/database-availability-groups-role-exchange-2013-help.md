---
title: 'Роль групп обеспечения доступности баз данных: Exchange 2013 Help'
TOCTitle: Роль групп обеспечения доступности баз данных
ms:assetid: 0b3e0f7a-21e5-4209-8d5b-b63c6b9de3cc
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876847(v=EXCHG.150)
ms:contentKeyID: 50487401
ms.date: 05/22/2018
...
Роль управления `Database Availability Groups` позволяет администраторам управлять группами доступности баз данных в организации. Администраторы, которым эта роль назначена напрямую или косвенно, являются администраторами наивысшего уровня, ответственными за обслуживание конфигурации высокой доступности в организации.
