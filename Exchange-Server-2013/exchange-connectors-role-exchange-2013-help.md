---
title: 'Роль соединителей Exchange: Exchange 2013 Help'
TOCTitle: Роль соединителей Exchange
ms:assetid: 73f98c82-bde0-443d-9bcf-274047e84e15
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876908(v=EXCHG.150)
ms:contentKeyID: 50488228
ms.date: 05/22/2018
...
Роль управления `Exchange Connectors` позволяет администраторам создавать, изменять, просматривать и удалять соединители агента доставки.

Роль не может быть использована для управления соединителями отправки и получения. Для управления соединителями отправки и получения используйте роли соединителей отправки и получения. Дополнительные сведения см. в следующих разделах:
