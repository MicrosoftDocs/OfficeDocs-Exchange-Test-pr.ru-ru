---
title: 'Роль правил транспорта: Exchange 2013 Help'
TOCTitle: Роль правил транспорта
ms:assetid: 53c5b1a5-e989-4373-ac70-7db16000c645
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876885(v=EXCHG.150)
ms:contentKeyID: 50488065
ms.date: 05/22/2018
...
Роль управления `Transport Rules` позволяет администраторам управлять правилами транспорта в организации.
