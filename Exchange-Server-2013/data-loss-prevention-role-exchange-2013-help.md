---
title: 'Роль предотвращения потери данных: Exchange 2013 Help'
TOCTitle: Роль предотвращения потери данных
ms:assetid: 026d0e48-f4da-416e-a00d-794bd3b38c5c
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ673034(v=EXCHG.150)
ms:contentKeyID: 50487354
ms.date: 05/22/2018
...
Роль управления "Предотвращение потери данных" позволяет администраторам создавать политики предотвращения потери данных (DLP) и управлять ими, а также создавать и изменять правила в этих политиках, что влияет на доставку почты во всей организации. Кроме того, данная роль дает администраторам возможность настраивать подсказки политик в почтовых клиентах и управлять отчетами о нарушении политики предотвращения потери данных. Данная роль предотвращения потери данных также обеспечивает доступ к правилам транспорта Microsoft Exchange. Дополнительные сведения о правилах транспорта в Exchange см. в следующих разделах:

  - [Роль правил транспорта](transport-rules-role-exchange-2013-help.md)

  - [Новые возможности правил транспорта](what-s-new-for-transport-rules-exchange-2013-help.md)
