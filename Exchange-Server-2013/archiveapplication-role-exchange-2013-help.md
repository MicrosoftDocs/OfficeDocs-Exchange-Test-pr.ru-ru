---
title: 'Роль ArchiveApplication: Exchange 2013 Help'
TOCTitle: Роль ArchiveApplication
ms:assetid: 22d673cf-d3a3-43f0-be1e-e4fc74546e64
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ673046(v=EXCHG.150)
ms:contentKeyID: 50487611
ms.date: 05/22/2018
...
Роль управления `ArchiveApplication` позволяет партнерским приложениям архивировать элементы в почтовых ящиках пользователей.
