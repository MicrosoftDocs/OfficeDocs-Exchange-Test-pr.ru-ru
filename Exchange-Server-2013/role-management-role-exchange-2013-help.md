---
title: 'Роль управления ролями: Exchange 2013 Help'
TOCTitle: Роль управления ролями
ms:assetid: 71d8553c-150d-4306-8de0-89be6efb5e40
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876906(v=EXCHG.150)
ms:contentKeyID: 50488218
ms.date: 05/22/2018
...
Роль управления `Role Management` позволяет администраторам управлять группами ролей управления; политиками назначения ролей и ролями управления; записями ролей, назначениями и областями в организации.

Пользователи, которым назначена эта роль, могут переопределять группу ролей, управляемую свойствами, настраивать любую группу ролей, а также добавлять или удалять участников в определенной группе ролей.
