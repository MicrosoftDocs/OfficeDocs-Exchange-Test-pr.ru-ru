---
title: 'Роль управления хранением: Exchange 2013 Help'
TOCTitle: Роль управления хранением
ms:assetid: ef16b495-c424-4ded-b5da-304e69ce31bb
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876953(v=EXCHG.150)
ms:contentKeyID: 50489459
ms.date: 05/22/2018
...
Роль управления `Retention Management` позволяет администраторам управлять политикой хранения данных в организации.
