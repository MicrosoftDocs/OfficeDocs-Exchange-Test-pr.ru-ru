---
title: 'Роль списков адресов: Exchange 2013 Help'
TOCTitle: Роль списков адресов
ms:assetid: 31143e30-16f5-45f5-b9a6-a39e6aa831d9
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876867(v=EXCHG.150)
ms:contentKeyID: 50487762
ms.date: 05/22/2018
...
Роль управления `Address Lists` позволяет администраторам создавать, изменять, просматривать и удалять списки адресов, глобальные списки адресов, политики адресной книги и автономные списки адресов в организации.
