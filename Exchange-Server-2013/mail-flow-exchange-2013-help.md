...
> [!NOTE]  
> Если в вашей сети периметра установлен пограничный транспортный сервер Exchange 2010 или Exchange 2007, поток обработки почты всегда проходит непосредственно между пограничным транспортным сервером и транспортной службой на сервере почтовых ящиков. Подробнее см. в разделе <a href="use-an-exchange-2010-or-2007-edge-transport-server-in-exchange-2013-exchange-2013-help.md">Использование пограничного транспортного сервера Exchange 2010 или 2007 в Exchange 2013</a>.
...
<tr class="odd">
<td><p><a href="https://docs.microsoft.com/ru-ru/exchange/security-and-compliance/mail-flow-rules/manage-message-approval">Управление утверждением сообщений</a></p></td>
