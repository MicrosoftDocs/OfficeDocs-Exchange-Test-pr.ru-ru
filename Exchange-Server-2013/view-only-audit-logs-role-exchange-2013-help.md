---
title: 'Роль только для просмотра журналов аудита: Exchange 2013 Help'
TOCTitle: Роль только для просмотра журналов аудита
ms:assetid: 9298fe59-0a16-4a09-bdb8-514d1cea6e2f
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Ff461933(v=EXCHG.150)
ms:contentKeyID: 50488644
ms.date: 05/22/2018
...
Роль управления `View-Only Audit Logs` позволяет администраторам и специалистам выполнять поиск в журналах аудита администратора в организации.
