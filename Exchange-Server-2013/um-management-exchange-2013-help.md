---
title: 'Управление единой системой обмена сообщениями: Exchange 2013 Help'
TOCTitle: Управление единой системой обмена сообщениями
ms:assetid: c91f0387-615c-4a1d-87d4-133ddac1e407
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd351142(v=EXCHG.150)
ms:contentKeyID: 50489184
ms.date: 05/22/2018
...
Дополнительные сведения о единой системе обмена сообщениями см. в разделе [Единая система обмена сообщениями](unified-messaging-exchange-2013-help.md).
