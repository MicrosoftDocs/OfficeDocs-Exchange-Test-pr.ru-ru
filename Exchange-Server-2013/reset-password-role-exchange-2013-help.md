---
title: 'Роль сброса пароля: Exchange 2013 Help'
TOCTitle: Роль сброса пароля
ms:assetid: d80101f1-7e3d-4a61-b93a-23da23e95e93
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/JJ657499(v=EXCHG.150)
ms:contentKeyID: 50489165
ms.date: 05/22/2018
...
Роль управления для сброса пароля позволяет отдельным пользователям сбрасывать собственные пароли, а администраторам — сбрасывать пароли пользователей в организации.
