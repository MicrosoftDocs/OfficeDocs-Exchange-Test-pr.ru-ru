---
title: 'Роль параметров транспорта организации: Exchange 2013 Help'
TOCTitle: Роль параметров транспорта организации
ms:assetid: ff4d032e-1b97-4a9d-b479-9b0d61832221
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876961(v=EXCHG.150)
ms:contentKeyID: 50489537
ms.date: 05/22/2018
...
Роль управления `Organization Transport Settings` используется для управления параметрами транспорта на уровне организации, например системными сообщениями, конфигурацией сайтов Active Directory, а также настройками конфигурации транспорта во всей организации Exchange.

Эта роль не позволяет создавать или управлять транспортными соединителями получения и отправки, очередями, санацией, агентами, удаленными и обслуживаемыми доменами или правилами транспорта. Для создания и управления любой транспортной функцией пользователю должна быть назначена одна или несколько из следующих ролей:
