---
title: 'Роль MyMobileInformation: Exchange 2013 Help'
TOCTitle: Роль MyMobileInformation
ms:assetid: b1048d12-3394-41c6-b10a-c01c1e0fdeb3
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Ff461935(v=EXCHG.150)
ms:contentKeyID: 50488862
ms.date: 05/22/2018
...
Пользователи могут использовать роль управления `MyMobileInformation` для просмотра и изменения параметров мобильного телефона и пейджера. Это пользовательская роль, созданная из родительской роли [Роль MyContactInformation](mycontactinformation-role-exchange-2013-help.md).
