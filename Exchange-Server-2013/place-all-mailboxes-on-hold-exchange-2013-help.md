...
С помощью Центра администрирования Exchange вы можете выбрать до 500 почтовых ящиков и применить к ним функцию хранения. Дополнительные сведения см. в статье [Создание или удаление инцидента хранения на месте](https://docs.microsoft.com/ru-ru/exchange/security-and-compliance/create-or-remove-in-place-holds).
