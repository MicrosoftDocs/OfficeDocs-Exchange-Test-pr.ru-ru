...
> [!NOTE]  
> Общедоступные папки доступны в следующих клиентах Outlook: Outlook Web App для Exchange 2013, Outlook 2007, Outlook 2010, Outlook 2013 и Outlook для Mac.
...
> [!NOTE]  
> В иерархии не хранится информация об адресах электронной почты для общедоступных папок с поддержкой почты. Адреса электронной почты хранятся в объекте каталога в Active Directory.
...
> [!IMPORTANT]  
> Поскольку существует только одна записываемая копия иерархии, создание папки передается в почтовый ящик иерархии почтовым ящиком содержимого, к которому подключены пользователи.
...
Подробнее см. в статье [Создание общедоступной папки](https://docs.microsoft.com/ru-ru/exchange/collaboration-exo/public-folders/create-public-folder).
