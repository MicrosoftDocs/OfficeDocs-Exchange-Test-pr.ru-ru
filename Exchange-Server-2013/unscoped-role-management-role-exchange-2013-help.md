---
title: 'Роль управления с незаданной областью: Exchange 2013 Help'
TOCTitle: Роль управления с незаданной областью
ms:assetid: d11eb843-64c9-4968-bfd5-9a8d94903058
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876943(v=EXCHG.150)
ms:contentKeyID: 50489268
ms.date: 05/22/2018
...
Роль управления `Unscoped Role Management` позволяет администраторам создавать в организации роли управления верхнего уровня с незаданными областями и управлять ими.
