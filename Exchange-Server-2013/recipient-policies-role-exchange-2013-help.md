---
title: 'Роль политик получателя: Exchange 2013 Help'
TOCTitle: Роль политик получателя
ms:assetid: 81c76e5d-bc57-4326-93ca-5e673c9aa85e
ms:mtpsurl: https://technet.microsoft.com/ru-ru/library/Dd876916(v=EXCHG.150)
ms:contentKeyID: 50488474
ms.date: 05/22/2018
...
Роль управления `Recipient Policies` позволяет администраторам управлять политиками получателей, например политиками регулирования, политиками почтовых ящиков Microsoft Office Outlook Web App, а также политиками для мобильных устройств в организации.
