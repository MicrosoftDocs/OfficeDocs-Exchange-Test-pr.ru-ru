...
> [!NOTE]  
> Для использования веб-частей Outlook Web App почтовый ящик пользователя и почтовый ящик, открываемый с помощью веб-части, должны находиться в одном лесу Active Directory.
...
> [!NOTE]  
> Строки для представлений по умолчанию автоматически получают URL-кодировку.
